...
import com.barbershop.appointments.utils.exceptions.InUseException;
...
public class GlobalControllerExceptionHandler {
    ...
    @ResponseStatus(UNPROCESSABLE_ENTITY)
    @ExceptionHandler(NoMoreThanFiveNumberOfPeopleException.class)
    public HttpErrorInfo handleNoMoreThanFiveNumberOfPeopleException(WebRequest request, Exception ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }

package com.barbershop.reviews.utils;


import com.barbershop.reviews.utils.exceptions.InUseException;
...
public class GlobalControllerExceptionHandler {
    ...
    public HttpErrorInfo handleInvalidScoreException(WebRequest request, Exception ex) {
        return createHttpErrorInfo(UNPROCESSABLE_ENTITY, request, ex);
    }
}
